  ...
  return (
    <footer className="bg-transparent dark:bg-gray-900 border-t border-gray-200 dark:border-gray-700 mt-20">
      <div className="max-w-6xl mx-auto px-6 py-12 sm:px-10 lg:px-20 flex flex-col md:flex-row justify-between gap-10">
        ...
        <div>
          <h3 className="text-2xl font-bold text-indigo-600 dark:text-indigo-400">CarefreeGeek</h3>
          <p className="text-gray-600 dark:text-gray-300 mt-2">
            Lorem ipsum dolor sit amet officiis ut, sunt inventore <br /> maiores libero! Inventore aut, dolorum ab repellat architecto <br /> optio porro nostrum placeat nisi.
          </p>
